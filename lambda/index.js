...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Agora estou mais inteligente! Como posso te ajudar?';
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Tudo bem! Agora me diga se você deseja parar! Ou se posso te ajudar em mais alguma coisa?';
...
const CancelAndStopIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Até mais! Se precisar, basta me deixar inteligente!';
...
const IntentReflectorHandler = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = `Não entendi, antes de falar diga! pergunta! ou apenas diga! cancelar!`;
